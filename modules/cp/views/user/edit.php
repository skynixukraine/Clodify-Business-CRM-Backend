...
<?php $form = ActiveForm::begin([
    ...
    <div class="form-group">
        ...
        <?php echo $form->field( $model, 'xHsluIp', ['inputOptions' => ['autocomplete' => 'off']])->textInput(["class" => "form-control", 'value' => ''])->label( 'Password' );?>
        ...
        <?php
            ...
            echo $form->field($model, 'auth_type')->radioList(\yii\helpers\ArrayHelper::map($auth_types, 'id', 'type_name')) ?>
