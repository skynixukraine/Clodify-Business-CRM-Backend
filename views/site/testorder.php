...
<form method="POST" action="https://api.privatbank.ua/p24api/ishop">
    ...
    <input type="hidden" name="return_url" value="https://staging.core.api.skynix.co/site/payment-status"/>
    <input type="hidden" name="server_url" value="https://staging.core.api.skynix.co/site/payment-callback"/>
