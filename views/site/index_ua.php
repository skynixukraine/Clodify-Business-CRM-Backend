...
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <h1 class="my-upper">про скайнікс </h1>
                        </div>
    ...
    <section class="container" id="working_fields">
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <h2 class="my-upper">ми працюємо в таких областях:</h2>
            </div>
    ...
    <section class="container" id="technology">
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <h3>
                    <span class="brand-name my-upper">скайнікс</span> прагне збагатити, урізноманітнити та спростити ваше життя
