    ...
    <section class="container" id="technology">
        <div class="row">
            ...
            <div class="col-lg-12 col-xs-12 technology-txt">
                Розробка програмного забезпечення вимагає від нас щоденного використання наступних технологій та мов програмування:
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12 portfolio-sample">
            ...
            <div class="info-box-hidden row">
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    Розробка програмного забезпечення відбувалася із використанням наступних технологій: Magento 1.x, HTML5, CSS3, Bootstrap, jQuery 1.x 
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6 col-xs-12 portfolio-sample">
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12 portfolio-sample">
            ...
            <div class="info-box-hidden row" >
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    Розробка програмного забезпечення проводилась із використанням: PHP 5.6, MySQL 5.6, HTML5, CSS3, Bootstrap, jQuery 2.x
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-6 col-xs-12 portfolio-sample">
            ...
            <div class="info-box-hidden row" >
                ...
                <div class="col-lg-6 col-sm-12">
                    <p>Цей мобільний додаток був створений командою Скайнікс Україна щоб зробити життя рибалок більш зручним. Fisherman ID надає змогу планувати поїздки та ділитися досягнутими результатами. Магазини із продажу відповідного спорядження можуть ефективно рекламувати свою продукцію. Складається із трьох частин: соціальна мережа, звітна система та реклама. 
                    </p>
                </div>
                <div class="col-lg-6 col-sm-12">
                    Розробка програмного забезпечення велася із використанням найсучасніших технологій:<br>
                    <ul>
