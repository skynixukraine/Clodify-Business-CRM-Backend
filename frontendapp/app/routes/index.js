...
let sliderSection_testimonials = [
  {
...
export default Ember.Route.extend({
  model() {
    return {
      ...
      sectionSoftware_solution: sectionSoftware_solution,
      sectionBusiness_solution: sectionBusiness_solution,
      sliderSection_why_skynix: sliderSection_why_skynix,
      sliderSection_testimonials: sliderSection_testimonials
    };
  },
});
