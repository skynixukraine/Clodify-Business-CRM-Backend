...
/**
 * Class m190305_093107_alter_approve_report_email_template
 */
class m190305_093107_alter_approve_report_email_template extends SkynixMigration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->insert(\app\models\EmailTemplate::tableName(), [
            'template'  => 'approve_report',
            'subject'   => '{FirstName} approved your report #{ReportID}',
    ...
    {
        echo "m190305_093107_alter_approve_report_email_template cannot be reverted.\n";
