...
class m180823_093706_refactor_invoice_pdf_template extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->renameTable('invoice_template', 'invoice_templates');
        $db = Yii::$app->getDb();
        $db->createCommand("ALTER TABLE `invoice_templates` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci")->execute();
        $db->createCommand("ALTER TABLE `email_templates` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci")->execute();


        $this->insert('invoice_templates', [
            'name' => 'invoicePDF',
            'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en">
<head>
...
'
    ...
    {
        echo "m180823_093706_refactor_invoice_pdf_template cannot be reverted.\n";
