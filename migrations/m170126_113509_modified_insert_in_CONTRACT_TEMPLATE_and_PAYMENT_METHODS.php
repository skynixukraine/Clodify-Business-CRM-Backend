...
class m170126_113509_modified_insert_in_CONTRACT_TEMPLATE_and_PAYMENT_METHODS extends SkynixMigration
{
    public function up()
    {
        $content = '
...
<table width="570" style=" margin-left: auto; margin-right: auto; border-collapse: collapse;">
    ...
    {
        echo "m170126_113509_modified_insert_in_CONTRACT_TEMPLATE_and_PAYMENT_METHODS cannot be reverted.\n";
