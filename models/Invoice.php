...
class Invoice extends \yii\db\ActiveRecord
{
    ...
    public function beforeSave($insert)
    {
        if( $this->isNewRecord ) {
            ...
            if($paymentMethod) {
                $business = Business::findOne(['id' => $paymentMethod->business_id, 'is_delete' => 0]);
                if($business) {
    ...
    /**
     * Check if invoice exists fot specified date and project
     *
     * @param Project $project
     * @param $date
     * @return bool
     */
    public static function existsInvoiceWithDate(Project $project, $date): bool
    {
