...
class Invoice extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(Business::className(), ['id' => 'payment_method_id']);
    }
    ...
    public function beforeSave($insert)
    {
        if( $this->isNewRecord ) {
            ...
            if ( ( $business = $this->getBusiness()->one() ) ) {

                $this->invoice_id = $business->invoice_increment_id;
                $business->invoice_increment_id++;
                $business->save(false, ['invoice_increment_id']);
