...
class Report extends \yii\db\ActiveRecord
{
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if($insert) {
            $project->cost = $project->cost + ($this->hours * ($user->salary / self::SALARY_HOURS));
            $project->save();
        }

        //if the field was updated it was necessary to substract the old value of cost
        if (isset($changedAttributes['hours'])){
            $project->cost -= ($changedAttributes['hours'] * ($user->salary / self::SALARY_HOURS));
            $project->save();
        }
