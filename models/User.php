...
//    [['sing'], 'file', 'skipOnEmpty' => false, 'extensions' => 'jpeg, jpg, png, gif', 'wrongExtension'=>'You can\'t upload files of this type.', 'on' => self::ATTACH_USERS_SIGN],
            ...
            [['is_active', 'salary', 'month_logged_hours', 'year_logged_hours', 'total_logged_hours', 'month_paid_hours',
                'year_paid_hours', 'total_paid_hours', 'is_delete', 'is_system', 'ticketId', 'is_published', 'experience_year', 'auth_type', 'pay_only_approved_hours'], 'integer'],
            ['phone', 'string', 'max' => 25],
    ...
    public function beforeSave($insert)
    {
        ...
        if (! $insert && $this->getOldAttribute('salary') !== $this->getAttribute('salary')) {
            $this->setAttribute('date_salary_up', date('Y-m-d'));
        }
