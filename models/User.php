...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public static function allCustomersWhithReceive()
    {
        return self::find()
            ...
            ->where(User::tableName() . ".is_delete=0 AND " . User::tableName() . ".is_active=1 AND " . Project::tableName() . ".status IN ('" . Project::STATUS_INPROGRESS . "' ) AND " . Project::tableName() . ".is_delete=0")
